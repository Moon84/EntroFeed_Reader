# -*- coding: utf-8 -*-
"""DeepSeek LLM Plugin for EntroFeed."""
...
class DeepSeekLLMHandler(ModelWrapperBase, LLMHandler):
    """DeepSeek handler for DeepSeek models."""
    ...
    def chat(self, messages: List[Dict[str, str]], **kwargs) -> str:
        """Make chat completion call to DeepSeek."""
        client = OpenAI(
...
LLMPluginRegistry.register(DeepSeekLLMHandler)
