# -*- coding: utf-8 -*-
"""Jira Notification Plugin for EntroFeed."""
...
class JiraNotificationHandler(NotificationPluginBase, NotificationHandler):
    ...
    async def send_notification(self, feed: Feed, entry: FeedEntry) -> None:
        ...
        if feed.notify_destination:
            ...
            logger.info(f"Creating issue in project {feed.notify_destination} - {project}")
        else:
        ...
        description = {
            ...
            "version": 1,
            "content": [
                {"type": "paragraph", "content": [{"text": entry.preview, "type": "text"}]},
                {
                    "type": "bulletList",
                    "content": [
                        {
                            ...
                            "content": [
                                {
                                    ...
                                    "content": [
                                        {
                                            "type": "text",
                                            "text": "Read in EntroFeed",
                                            "marks": [{"type": "link", "attrs": {"href": self.make_read_link(entry)}}],
                                        }
                                    ],
                                }
                            ],
                                    ...
                                    "content": [
                                        {
                                            "type": "text",
                                            "text": "Read Original",
                                            "marks": [{"type": "link", "attrs": {"href": entry.url}}],
                                        }
                                    ],
                                }
                            ],
...
NotificationPluginRegistry.register(JiraNotificationHandler)
